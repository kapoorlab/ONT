...
RawBin2Normalsave_dir = Rawsave_dir + 'DynamicNormalEventTrainingDataBin2'
RawBin2Macrocheatesave_dir = Rawsave_dir + 'DynamicMacroKittyEventTrainingDataBin2'
RawBin2NonMaturesave_dir = Rawsave_dir + 'DynamicNonMatureP1EventTrainingDataBin2'
RawBin2Maturesave_dir = Rawsave_dir + 'DynamicMatureP1EventTrainingDataBin2'
