...
class NEATDetection(object):
    ...
    def __init__(self, NpzDirectory, TrainModelName, ValidationModelName, categories, Categories_Name, model_dir, model_name, model_keras, depth = 29, model_weights = None, cardinality = 1,  lstm_hidden_unit1 = 4, epochs = 55, batch_size = 20,  show = False):        
    ...
    def TrainModel(self):
        ...
        self.Trainingmodel = self.model_keras(input_shape, self.categories, box_vector = Y_rest.shape[-1] , depth = self.depth, input_weights  =  self.model_weights,  unit = self.lstm_hidden_unit1, cardinality = self.cardinality)
